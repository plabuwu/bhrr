...
bun run dev:backend # if using bun runtime
bun run dev:worker # if using cloudflare workers
```
...
2. Deploy the frontend assets and backend API to Cloudflare Workers

Note: You'll need to configure your Cloudflare credentials for deployment.
